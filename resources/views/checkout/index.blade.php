...
@section('content')
      <div class="col-md-12">
         ...
         <div class="row">
             <div class="col-md-6">
                <form id="payment-form" class="my-4" action="{{route('check.paiement')}}" method="POST">
                    @csrf
                    <div id="card-element">

                    </div>
                    <div id="card-errors" role="alert"></div>
                    <button id="submit" class="btn btn-success  btn-block mt-3 my-4">Proceder au Paiement ({{ getPrice(Cart::total()) }})</button>
                  </form>
             </div>
         </div>
      </div>
...
<script>
  ...
  //  document.getElementsByClassName('blog-header')[0].classList.add("d-none");
    ...
    // Paiement Stripe
    var stripe = Stripe('pk_test_W18eP0JBak9NEEzJdmDURCS600ZqHXS9GP');
