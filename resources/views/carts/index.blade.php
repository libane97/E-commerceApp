...
@section('content')
            ...
            <div class="row py-5 p-4 bg-white rounded shadow-sm">
              ...
              <div class="col-lg-6">
                ...
                <div class="p-4">
                  ...
                  </ul><a href="{{route('check.paiement')}}" class="btn btn-dark rounded-pill py-2 btn-block"> <i class="fa fa-credit-card" aria-hidden="true"></i>  Passer à la caisse</a>
                </div>
              </div>
            </div>
      ...
      @else
         <div class="col-md-12">
               <div class="col-md-6">
                           <p>Votre est vide veuillez ajoute des produits <a href="{{route('index')}}">Ajoute de produit</a></p>
               </div>
         </div>
      @endif
@endsection
